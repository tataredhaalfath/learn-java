...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        dataNumbers.stream().forEach(number -> System.out.println("Lambda " + number));
        ...
        List<String> filtered = dataNumbers.stream()
                ...
                .toList();
        filtered.stream().forEach(num -> System.out.println(num + " . " + num.getClass().getSimpleName()));
        System.out.println(filtered);
        System.out.println(dataNumbers);

        System.out.println("");
        // combine 2 list
        List<Integer> firstNumbers = new ArrayList<>(Arrays.asList(3, 4, 5, 9, 1, 2));
        ...
        List<String> frontendTrainees = new ArrayList<>(Arrays.asList("patrick", "erin"));
